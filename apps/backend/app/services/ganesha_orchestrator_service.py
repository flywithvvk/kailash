...
class GaneshaOrchestratorService:
    ...
    async def _analyze_with_claude(
        ...
        system_prompt = f"""You are GANESHA, the AI orchestrator for KAILASH AEGIS HU (Go4Garage URGAA platform).
...
**Project Context:**
- Platform: KAILASH AEGIS HU (Organizational management system)
...
**Current User:**
- AEGIS Code: {user_context.get('aegis_code', 'Unknown')}
