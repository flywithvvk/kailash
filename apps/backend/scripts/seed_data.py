#!/usr/bin/env python3
"""
Data seeding script for KAILASH AEGIS HU
Seeds the database with:
. Initial user (Vivek with AEGIS code <REDACTED_AEGIS_CODE>)
...
async def seed_database():
    ...
    try:
        ...
        if not existing_user:
            ...
            print(f"   [OK] Created user: Vivek Kumar (<REDACTED_AEGIS_CODE>)")
        else:
            print(f"   ℹ️  User already exists: <REDACTED_AEGIS_CODE>")
        ...
        print("   AEGIS Code: <REDACTED_AEGIS_CODE>")
