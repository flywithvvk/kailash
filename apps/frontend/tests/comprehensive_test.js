...
async function login(page) {
  ...
  await page.waitForSelector('input[name="aegis_code"], input[placeholder*="AEGIS"]', { timeout: 5000 });
  
  await page.type('input[name="aegis_code"], input[placeholder*="AEGIS"]', CREDENTIALS.aegis_code);
