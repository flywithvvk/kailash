...
export const LoginForm = ({ onLogin, isLoading }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!credentials.aegisCode || !credentials.decode) {
    ...
    <div className="w-full max-w-[480px] animate-slide-up" style={{ animationDelay: "300ms" }}>
      ...
      <div className="glass border border-[hsl(var(--g4g-purple)_/_0.1)] rounded-[20px] p-12 relative"
        ...
        <div className="text-center mb-6">
          <h2 className="text-2xl font-bold text-[hsl(var(--g4g-purple))] mb-2">Welcome to AEGIS HUB</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-2">
            <Label htmlFor="aegisCode" className="flex items-center gap-2 text-[hsl(var(--g4g-purple))] font-semibold">
            ...
            <div className="relative">
              ...
              <Input
                ...
                value={credentials.aegisCode}
                onChange={(e) => setCredentials({...credentials, aegisCode: e.target.value})}
