    ...
    <div className="legal-document-container">
      ...
      <div className="legal-content">
        <section>
          ...
          <p>
            This Acceptable Use Policy ("AUP") governs your use of the AEGISHUB platform operated by Go4Garage. 
            By accessing or using AEGISHUB, you agree to comply with this policy. This AUP is designed to protect 
            the integrity, security, and availability of our EV charging infrastructure management platform for all users.
          </p>
          <p>
            AEGISHUB provides enterprise-grade management tools for electric vehicle charging operations. Misuse of 
        ...
        <section>
          ...
          <p>You may use AEGISHUB for the following authorized purposes:</p>
          <ul>
            ...
            <li><strong>API Integration:</strong> Integrate AEGISHUB with your business systems via official APIs</li>
        ...
        <section>
          ...
          <p>The following activities are strictly prohibited when using AEGISHUB:</p>
          ...
          <ul>
            ...
            <li>Selling, renting, or transferring access to AEGISHUB</li>
          ...
          <ul>
            <li>Using AEGISHUB for any illegal purpose under Indian law</li>
        ...
        <section>
          ...
          <p>You are responsible for maintaining the security of your AEGISHUB account:</p>
          <ul>
            <li><strong>Password Protection:</strong> Keep your Decode (password) confidential and secure</li>
            <li><strong>Authorized Access Only:</strong> Do not share your AEGIS Code with others</li>
            <li><strong>Device Security:</strong> Use secure devices and networks to access AEGISHUB</li>
        ...
        <section>
          ...
          <p>
            Go4Garage actively monitors AEGISHUB usage to ensure compliance with this AUP. Our SHIV security 
        ...
        <section>
          ...
          <p>
            Continued use of AEGISHUB after policy updates constitutes acceptance of the revised AUP.
          </p>
        </section>

        <section>
          <h2>10. Your Responsibilities</h2>
          <p>By using AEGISHUB, you agree to:</p>
          <ul>
