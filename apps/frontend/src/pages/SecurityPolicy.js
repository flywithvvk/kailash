    ...
    <div className="legal-document-container">
      ...
      <div className="legal-content">
        <section>
          ...
          <p>
            Go4Garage is committed to maintaining the highest standards of information security for the AEGISHUB platform. 
          ...
          <p>
            AEGISHUB manages mission-critical charging operations. Security is not just a feature—it's the foundation 
        ...
        <section>
          ...
          <p>All data stored in AEGISHUB is encrypted:</p>
          <ul>
