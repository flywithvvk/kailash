    ...
    <div className="legal-document-container">
      ...
      <div className="legal-content">
        <section>
          <h2>1. Overview</h2>
          <p>
            This Refund and Cancellation Policy governs refund requests for AEGISHUB platform services provided 
          ...
          <p>
            AEGISHUB is an enterprise platform for managing electric vehicle charging operations. This policy 
            applies to subscription fees, usage charges, and any other payments made for AEGISHUB services.
          </p>
        </section>
        ...
        <section>
          ...
          <p>Fees for actual charging sessions managed through AEGISHUB:</p>
          <ul>
        ...
        <section>
          ...
          <ul>
            <li>Log into AEGISHUB dashboard</li>
          ...
          <ul>
            ...
            <li>Subject: "Subscription Cancellation - [Your AEGIS Code]"</li>
        ...
        <section>
          ...
          <p>If Go4Garage discontinues AEGISHUB:</p>
          <ul>
