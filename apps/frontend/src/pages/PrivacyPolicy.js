        ...
        <div className="bg-white rounded-2xl shadow-lg p-12">
          ...
          <div className="space-y-8 text-gray-700 leading-relaxed">
            ...
            <section>
              ...
              <p className="mb-4">When you use AEGIS HUB, we collect:</p>
              <ul className="list-disc list-inside space-y-2 ml-4 mb-4">
                <li><strong>Account Information:</strong> AEGIS Code (username), email address, phone number</li>
              ...
              <p className="mb-4">We automatically collect information about how you interact with AEGIS HUB:</p>
              <ul className="list-disc list-inside space-y-2 ml-4 mb-4">
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4 mb-4">
                <li>Provide and maintain AEGIS HUB platform services</li>
            ...
            <section>
              ...
              <p className="mb-4">AEGIS HUB uses cookies and similar technologies:</p>
            ...
            <section>
              ...
              <p className="mb-4">
                AEGIS HUB is not intended for individuals under the age of 18. We do not knowingly collect personal information from children. If we become aware that we have collected information from a child, we will take steps to delete it immediately.
              </p>
            </section>
